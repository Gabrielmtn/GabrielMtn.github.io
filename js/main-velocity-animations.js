...
$("div.intro-lead-in").velocity({rotateX:["0" , "-14"],color:"#eee", scale:[ "1" , "0.99"],opacity:[ "0" , "0"] }, { duration: 550, delay: 0, easing : "linear"  });
...
$("div.intro-heading").velocity({rotateX:[ "0" , "-14"], color:"#eee", scale:[ "1" , "0.99"],opacity:[ "0" , "0"] }, { duration: 550, delay: 0, easing : "linear"  });
